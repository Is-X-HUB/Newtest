...
local win = library:Window("   Queue Hub","     ["..GetName.Name.."]","ทำเองใช้เองไม่แจก",Enum.KeyCode.RightControl)
local Main = win:Tab("General",[[6026568198]])
local Set = win:Tab("Setting",[[15712711639]])
local Farm = win:Tab("Other Farm",[[15712717270]])
local Stats = win:Tab("Stats",[[7040410130]])
local Race = win:Tab("Race V4",[[15712776421]]
local Event = win:Tab("Games Event",[[15806749681]]))
local Tele = win:Tab("Teleport",[[157127388]]))
local Player = win:Tab("Players",[[7251993295]])
local DemonFruit = win:Tab("Devil Fruit",[[15712758182]]))
local Raid = win:Tab("Raid",[[15712763124]]))
local Shop = win:Tab("Shop",[[6031265976]])
local Misc = win:Tab("Misc",[[6034509993]])

HomePage:Seperator("X Hub")
